  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden font-sans">
      ...
      <div className="relative z-10 text-center text-white px-4">
        <h3 className="text-xl md:text-2xl font-medium mb-4 tracking-wide text-gray-200">
          Welcome
        </h3>
        <h1 className="text-5xl md:text-7xl font-bold mb-6 flex items-center justify-center">
          <span className="mr-2.5">I'm</span>

          {/* Type effect */}
          <span className="text-white">
            <Typewriter
              words={["Rieme Hasan", "a Frontend Developer", "a Designer"]}
              loop={0}
              cursor
              cursorStyle="_"
              typeSpeed={80}
